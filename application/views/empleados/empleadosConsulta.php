                        ...
                        <div class="table-responsive" ng-show="filteredItems > 0">
                            <table id="user-signups" class="table table-striped table-bordered">
                                ...
                                <?php foreach($datos as $fila){ ?>
                                    ...
                                    <tr>
                                        <td class="hidden-xs" ng-click=""><?php echo  $fila->idEmpleado;?></td>
                                        <td> <?php echo $fila->nombre ?></td>

                                        <td> <a href= <?= "'".base_url('empleados/editarEmpleados/')."/".$fila->idEmpleado."'";?> > <button type="button" class="btn btn-primary">Editar</button> </a> <a href= <?= "'".base_url('empleados/borrarEmpleado/')."/".$fila->idEmpleado."'";?> ><button type="button" class="btn btn-danger">Eliminar</button></a>
                                    </tr>
                                <?php } ?>
                                </tbody>
